...
const READ_ANSWER_TOPICS = [
  {
    id: "greetings",
    title: "Greetings",
    description: "Listen and fill in common greeting phrases",
    total: 4,
    completed: 4,
  ...
  },
  {
    ...
    description: "Listen and fill in words about daily routines",
    total: 4,
    completed: 3,
  ...
  },
  {
    id: "animals",
    title: "Animals",
    description: "Listen and fill in names of animals",
    total: 4,
    completed: 2,
  ...
  },
  {
    id: "food",
    title: "Food & Drinks",
    description: "Listen and fill in names of food and drinks",
    total: 4,
    completed: 1,
  ...
  },
  {
    id: "sports",
    title: "Sports",
    description: "Listen and fill in sports vocabulary",
    total: 4,
    completed: 0,
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-20">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white mb-2">Practice Reading</h1>
          <p className="text-cyan-300 text-lg">Read and Choose the correct answer</p>
        </div>

        {/* Topic List */}
        <div className="w-full max-w-2xl space-y-4">
          {READ_ANSWER_TOPICS.map((topic) => (
            <Link
              key={topic.id}
              href={`/client/practice/read-answer/${topic.id}`}
