    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-20">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white mb-2">Reading Story</h1>
          <p className="text-cyan-300 text-lg">Enjoy reading story for practice</p>
        </div>

        {/* Topic List */}
        <div className="w-full max-w-2xl space-y-4">
          {READ_STORY_TOPICS.map((topic) => (
            <Link
              key={topic.id}
              href={`/client/practice/read-story/${topic.id}`}
