...
const listenFill = {
  greetings: [
    fillItem("Good Morning", "lf-greeting-1", [text("Every morning I say "), blank("b1", "hello"), text(" to my "), blank("b2", "teacher"), text(". She smiles and says "), blank("b3", "good"), text(" "), blank("b4", "morning"), text(" back.")]),
    fillItem("Polite Words", "lf-greeting-2", [text("When I need "), blank("b1", "help"), text(", I say "), blank("b2", "please"), text(". When my "), blank("b3", "friend"), text(" helps me, I say "), blank("b4", "thank"), text(" you.")]),
    fillItem("Saying Goodbye", "lf-greeting-3", [text("After "), blank("b1", "school"), text(", we "), blank("b2", "wave"), text(" and say "), blank("b3", "goodbye"), text(". My teacher says, see you "), blank("b4", "tomorrow"), text(".")]),
    fillItem("Meeting Friends", "lf-greeting-4", [text("I meet a new "), blank("b1", "friend"), text(" and say nice to "), blank("b2", "meet"), text(" you. She says "), blank("b3", "welcome"), text(" to our "), blank("b4", "class"), text(".")]),
  ],
  "daily-activities": [
    fillItem("Morning Routine", "daily", [text("Every morning I "), blank("b1", "wake"), text(" up at "), blank("b2", "seven"), text(" o'clock. I "), blank("b3", "brush"), text(" my teeth and "), blank("b4", "wash"), text(" my face.")]),
    fillItem("Going to School", "daily2", [text("After "), blank("b1", "breakfast"), text(" I "), blank("b2", "go"), text(" to school by "), blank("b3", "bus"), text(". Classes "), blank("b4", "start"), text(" at eight thirty.")]),
    fillItem("Afternoon", "daily3", [text("In the "), blank("b1", "afternoon"), text(" I "), blank("b2", "do"), text(" my homework. Then I "), blank("b3", "play"), text(" outside with my "), blank("b4", "friends"), text(".")]),
    fillItem("Night Routine", "daily4", [text("At "), blank("b1", "night"), text(" I "), blank("b2", "eat"), text(" dinner with my family and "), blank("b3", "watch"), text(" TV. I "), blank("b4", "sleep"), text(" at ten o'clock.")]),
  ],
  animals: [
    fillItem("Lions", "animals1", [text(""), blank("b1", "Lions"), text(" are called the "), blank("b2", "king"), text(" of the jungle. They "), blank("b3", "hunt"), text(" in groups called "), blank("b4", "prides"), text(".")]),
    fillItem("Elephants", "animals2", [text(""), blank("b1", "Elephants"), text(" are the largest "), blank("b2", "land"), text(" animals. They use their "), blank("b3", "trunks"), text(" to "), blank("b4", "drink"), text(" water.")]),
    fillItem("Dolphins", "animals3", [text(""), blank("b1", "Dolphins"), text(" are very "), blank("b2", "smart"), text(" animals. They "), blank("b3", "live"), text(" in the "), blank("b4", "ocean"), text(".")]),
    fillItem("Penguins", "animals4", [text(""), blank("b1", "Penguins"), text(" cannot "), blank("b2", "fly"), text(" but they are excellent "), blank("b3", "swimmers"), text(". They "), blank("b4", "live"), text(" in Antarctica.")]),
  ],
  food: [
    fillItem("Healthy Food", "food1", [text("Eating "), blank("b1", "fruits"), text(" and "), blank("b2", "vegetables"), text(" is good for our "), blank("b3", "health"), text(". We should eat them every "), blank("b4", "day"), text(".")]),
    fillItem("Strong Bones", "food2", [text(""), blank("b1", "Milk"), text(" gives us strong "), blank("b2", "bones"), text(". Meat and eggs give us "), blank("b3", "protein"), text(" to "), blank("b4", "grow"), text(".")]),
    fillItem("Water", "food3", [text("Too much "), blank("b1", "sugar"), text(" is bad for our "), blank("b2", "teeth"), text(". We should "), blank("b3", "drink"), text(" plenty of "), blank("b4", "water"), text(" instead.")]),
    fillItem("Energy", "food4", [text("A "), blank("b1", "balanced"), text(" diet keeps us "), blank("b2", "healthy"), text(" and gives us "), blank("b3", "energy"), text(" every "), blank("b4", "day"), text(".")]),
  ],
  sports: [
    fillItem("Football", "sports1", [text("In "), blank("b1", "football"), text(", players "), blank("b2", "kick"), text(" the ball and try to "), blank("b3", "score"), text(" a "), blank("b4", "goal"), text(".")]),
    fillItem("Basketball", "sports2", [text("In "), blank("b1", "basketball"), text(", players "), blank("b2", "throw"), text(" the "), blank("b3", "ball"), text(" into a "), blank("b4", "hoop"), text(".")]),
    fillItem("Swimming", "sports3", [text(""), blank("b1", "Swimming"), text(" is good "), blank("b2", "exercise"), text(". You move your "), blank("b3", "whole"), text(" "), blank("b4", "body"), text(" in the water.")]),
    fillItem("Tennis", "sports4", [text("Tennis players use a "), blank("b1", "racket"), text(" and hit the "), blank("b2", "ball"), text(" over a "), blank("b3", "net"), text(" on the "), blank("b4", "court"), text(".")]),
  ],
};
...
const readAnswer = {
  greetings: [
    qaItem("Hello! My name is Tom. I am eight years old. I go to school every day. I like to say hello to my friends. I always say thank you when someone helps me.", [
      ...
      { id: 4, statement: "Tom likes to say hello to his friends.", answer: true },
    ]),
    qaItem("Good morning! Anna wakes up at seven o'clock. She says good morning to her mum and dad. She eats breakfast and goes to school. She says goodbye before she leaves.", [
      ...
      { id: 4, statement: "Anna eats breakfast before school.", answer: true },
    ]),
    qaItem("Please and sorry are important words. If you want something, say please. If you make a mistake, say sorry. These words make people feel good.", [
      ...
      { id: 4, statement: "These words make people feel bad.", answer: false },
    ]),
    qaItem("Welcome to our school! We are happy you are here. You will meet many friends. Everyone is kind and polite. We greet each other every morning.", [
      ...
      { id: 4, statement: "The new student will meet many friends.", answer: true },
    ]),
  ],
  "daily-activities": [
    qaItem("It is eight o'clock in the morning. Anna is going out with her friends. It's spring. She loves the weather. It's warm. Anna likes autumn, too. It is cool. She can go to the zoo with her parents. Anna doesn't like winter. It is cold and snowy.", [
      ...
      { id: 4, statement: "Winter is cold and snowy.", answer: true },
    ]),
    qaItem("Ben rides his bike every afternoon. He puts on his helmet before riding. He goes to the park near his house. Sometimes his dog runs next to him. Ben loves riding his bike.", [
      ...
      { id: 4, statement: "Ben goes to the park near his house.", answer: true },
    ]),
    qaItem("Lucy likes cooking with her mother. They cook dinner together on Saturdays. Lucy can make pasta and soup. Her father says her soup is delicious. Lucy feels happy when people enjoy her food.", [
      ...
      { id: 4, statement: "Lucy feels sad when people enjoy her food.", answer: false },
    ]),
    qaItem("Sam goes to bed at nine o'clock. He brushes his teeth and reads a book. His mum turns off the light. Sam sleeps for eight hours. He wakes up feeling fresh and ready for school.", [
      ...
      { id: 4, statement: "Sam wakes up ready for school.", answer: true },
    ]),
  ],
  animals: [
    qaItem("Dogs are great pets. They are friendly and loyal. Dogs love to play and run outside. They need food and water every day. Dogs can also learn many tricks. They are a human's best friend.", [
      ...
      { id: 4, statement: "Dogs are a human's best friend.", answer: true },
    ]),
    qaItem("Cats are quiet animals. They sleep a lot during the day. Cats like to play with toys. They clean themselves by licking their fur. Cats purr when they are happy.", [
      ...
      { id: 4, statement: "Cats sleep a lot during the day.", answer: true },
    ]),
    qaItem("Elephants are the biggest land animals. They live in Africa and Asia. Elephants use their trunks to pick up food and drink water. Baby elephants stay close to their mothers.", [
      ...
      { id: 4, statement: "Elephants live in Africa and Asia.", answer: true },
    ]),
    qaItem("Rabbits are soft and cute animals. They have long ears and short tails. Rabbits eat vegetables like carrots and lettuce. They hop around to move from place to place.", [
      ...
      { id: 4, statement: "Rabbits have long tails.", answer: false },
    ]),
  ],
  food: [
    qaItem("Fruits are healthy foods. Apples are red or green. Bananas are yellow and sweet. Oranges are full of vitamin C. Eating fruit every day keeps you healthy and strong.", [
      ...
      { id: 4, statement: "Apples can be red or green.", answer: true },
    ]),
    qaItem("Pizza is a popular food. It has a bread base with tomato sauce and cheese. You can add vegetables or meat on top. Pizza is baked in a very hot oven.", [
      ...
      { id: 4, statement: "Pizza has tomato sauce and cheese.", answer: true },
    ]),
    qaItem("Milk is a healthy drink. It comes from cows. Milk has calcium that makes your bones strong. Children should drink milk every day. You can also eat cheese and yogurt made from milk.", [
      ...
      { id: 4, statement: "Children should drink milk every day.", answer: true },
    ]),
    qaItem("Bread is made from flour and water. Bakers bake bread in an oven. There are many kinds of bread: white bread, brown bread, and wholegrain bread. Bread gives you energy for the day.", [
      ...
      { id: 4, statement: "Bakers bake bread in an oven.", answer: true },
    ]),
  ],
  sports: [
    qaItem("Football is the most popular sport in the world. Players kick a ball into the other team's goal. Each team has eleven players. A match lasts ninety minutes. The team with the most goals wins.", [
      ...
      { id: 4, statement: "The team with the fewest goals wins.", answer: false },
    ]),
    qaItem("Basketball is played on a court. Players throw a ball through a hoop. Each team has five players. The game has four quarters. You score two points for most baskets.", [
      ...
      { id: 4, statement: "You score two points for most baskets.", answer: true },
    ]),
    qaItem("Swimming is great exercise. You use your whole body when you swim. There are different styles: freestyle, backstroke, and butterfly. Swimming keeps your heart healthy.", [
      ...
      { id: 4, statement: "Butterfly is a swimming style.", answer: true },
    ]),
    qaItem("Tennis is played with a racket and a ball. Two or four players can play. The court is divided by a net. Players hit the ball over the net. You win a point when the other player misses the ball.", [
      ...
      { id: 4, statement: "Two or four players can play tennis.", answer: true },
    ]),
  ],
};
